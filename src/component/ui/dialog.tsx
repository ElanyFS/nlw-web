  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.DialogContent
        {...props}
        className="fixed z-50 right-0 top-0 bottom-0 w-[450px] h-screen border-l border-zinc-900 bg-zinc-950 px-6 py-2 overflow-y-auto"
      />
    </DialogPortal>
  )
}
...
export function DialogTitle(props: DialogPrimitive.DialogTitleProps) {
  return (
    <DialogPrimitive.DialogTitle {...props} className="text-lg font-semibold text-zinc-50" />
  )
}
